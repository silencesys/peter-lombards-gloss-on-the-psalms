        ...
        vm.init().then(() => {
          vm.$nextTick(function () {
            ...
            if (vm.computedHeight / vm.computedWidth < vm.imgHeight / vm.imgWidth) {
              ...
              vm.imgHeight = (vm.imgHeight * vm.computedWidth / vm.imgWidth) * this.size
              vm.imgWidth  = vm.computedWidth * this.size
            }
            vm.styleObjectImg.backgroundImage = "url(" + vm.imgUrl + ")";
            ...
            vm.styleObjectImg.backgroundPosition = this.position.x + "px " + this.position.y + "px";
          });
        })
      });
    }
